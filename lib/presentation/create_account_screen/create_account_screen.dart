                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          CustomTextFormField(
                              ...
                              margin: getMargin(left: 25, top: 16, right: 25),
                          ...
                          Obx(() => CustomTextFormField(
                              ...
                              prefix: Container(
                                  margin: getMargin(
                                      left: 29, top: 17, right: 25, bottom: 17),
                                  child: CustomImageView(
                          ...
                          CustomButton(
                              ...
                              margin: getMargin(left: 16, top: 18, right: 18)),
                          Padding(
                              padding: getPadding(left: 32, top: 20, right: 19),
                              child: Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    Padding(
                                    ...
                                    Padding(
                                        ...
                                        child: Text("msg_or_create_account".tr,
                                            overflow: TextOverflow.ellipsis,
                                            textAlign: TextAlign.left,
                                            style: AppStyle
                          ...
                          Padding(
                              padding: getPadding(left: 26, top: 13, right: 24),
                              child: Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    CustomButton(
