  ...
  Widget build(BuildContext context) {
    return SafeArea(
        child: Scaffold(
            ...
            Obx(() => InkWell(
                    onTap: controller.selectParent, // Call the switchLanguage method on tap
                    child: Container(
                          margin: getMargin(top: 24, right: 1),
                          padding: getPadding(
                              left: 40, top: 14, right: 40, bottom: 14),
                             decoration:    controller.accountTypeModelObj.value.parent ? AppDecoration.fillPurpleA400.copyWith(
                              ...
                              children: [
                                Padding(
                                    ...
                                    child: Text("lbl_parent".tr,
                                        ...
                                        controller.accountTypeModelObj.value.parent ?
            ...
            Obx(() => InkWell( onTap: controller.selectTeacher,child: Container(
                          margin: getMargin(top: 31, right: 1),
                          padding: getPadding(
                              left: 40, top: 14, right: 40, bottom: 14),
                          decoration:   controller.accountTypeModelObj.value.parent ?
